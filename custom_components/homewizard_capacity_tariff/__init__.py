"""
Custom integration to integrate homewizard_capacity_tariff with Home Assistant.

For more details about this integration, please refer to
https://github.com/bertvansteen/homewizard_capacity_tariff
"""
...
from .data import HomeWizardCapacityTariffData
...
async def async_setup_entry(
    ...
    entry.runtime_data = HomeWizardCapacityTariffData(
